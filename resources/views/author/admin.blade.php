    ...
    @foreach($authors as $author)
        <div class="alert alert-warning">
            <div
                ...
                <h3 class="my-0 mr-md-auto font-weight-normal"><a href="{{ route('author.show', ['author'=>$author->id]) }}"
                                                                  class="text-reset">{{ $author->name }}</a></h3>
                <nav class="my-2 my-md-0 mr-md-3">
                    <a class="p-2 text-white btn btn-primary"
                       href={{ route('author.edit', ['author'=>$author->id]) }}>Edit</a>
                </nav>
